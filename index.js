/**
 * Created by cpoopc on 2016/8/27.
 */
...
module.exports.pitch = function(request) {
    ...
    //fs.writeFile('cplog.txt', JSON.stringify(request) + '\n query:' + JSON.stringify(query) + '\n option:' + JSON.stringify(this.options), null, 2)
    workerCompiler.runAsChild(function(err, entries, compilation) {
        ...
        if (entries[0]) {
            ...
            if(query.url) {
                // 仅返回url
                return callback(null, "var url = __webpack_public_path__ + " + JSON.stringify(workerFile) + ";\n\tmodule.exports = url")
            }
